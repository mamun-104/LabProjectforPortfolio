...
<body background="black-and-white-city-houses-skyline.jpg"   style="background-repeat:no-repeat;
...
<div class="topnav">
  ...
  <a class="active"  href="loginuser.php">User Log-In</a>
...
<p> <h1 align="center" style="font-size:30px; font-family:Verdana, Arial, Helvetica, sans-serif; color: #FF9966; background-color: #FFFFFF">User Login Section</h1> </p>
...
<h1>Log-In Now!<span>Log-In and Pay your Bills</span></h1>

<form action="hellouser.php" method="POST">

    <div class="section"><span>1</span>User Name</div>
    <div class="inner-wrap">
        <label style="font-size:15px;"> <input type="text" id="user" name="username" placeholder="Please Give Your Username" required /></label>
        
    </div>

    <div class="section"><span>2</span>Password</div>
    <div class="inner-wrap">
        <label style="font-size:15px;"> <input type="text" id="user" name="password" placeholder="Please Give Your Password" required /></label>
        
    </div>

    
    <input style="height:40px; width:100px; font-size:20px; background-color:#2A88AD; color: #FFFFFF" type="submit" id="btn" value="LOGIN" />
